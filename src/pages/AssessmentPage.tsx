...
import RiskAssessmentResults from "@/components/assessment/RiskAssessmentResults.tsx";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (hba1c > 15 || hba1c < 3) {
      toast({
        ...
        description: "HbA1c should be between 3% and 15%.",
        variant: "destructive",
      });
      return;
    }
    if (glucose > 600 || glucose < 50) {
      toast({
        title: "Invalid Blood Glucose",
        description: "Blood glucose should be between 50 and 600 mg/dL.",
        variant: "destructive",
      });
      return;
    }
    ...
    <AppLayout>
            ...
            <div className="form-field">
                  ...
                  <SelectContent>
                    {patients.map((patient) => (
                      <SelectItem key={patient.id} value={patient.id}>
                        {patient.first_name} {patient.last_name} (MRN:{" "}
                        {patient.patient_id})
                      </SelectItem>
                    ))}
                  </SelectContent>
              ...
              {patients.length === 0 && (
                <p className="field-hint">
                  ...
                  <button
                    type="button"
                    className="text-[var(--color-text-brand)] underline"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="form-field">
                ...
                <div className="flex items-center gap-0">
                  ...
                  />
                  <span
                    className="h-9 px-3 flex items-center border border-l-0 rounded-r-[var(--radius-md)] text-sm"
                    style={{
            ...
            <div className="form-field">
              ...
              <div className="flex items-center gap-0">
                <Input
                  ...
                  onChange={(e) =>
                    handleChange("blood_glucose_level", e.target.value)
                  }
                  className="rounded-r-none"
                />
                <span
        ...
        <SectionCard number={3} title="Lifestyle Factors">
          <div className="form-field max-w-sm">
            ...
            <Select
              ...
              onValueChange={(value) =>
                handleChange("smoking_history", value as SmokingHistory)
              }
            >
              <SelectTrigger id="smoking_history">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <Label
                ...
                className="normal-case tracking-normal text-sm font-normal"
            ...
            <div className="flex items-center gap-3">
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleChange("heart_disease", checked)
                }
              />
              <Label
                ...
                <div key={step} className="flex items-center gap-3">
                  {i < predictionStep ? (
                    <CheckCircle2
                      ...
                      style={{ color: "var(--color-risk-low-accent)" }}
                    />
                  ) : i === predictionStep ? (
      ...
      {showResults && assessmentResult && (
        <RiskAssessmentResults
          ...
          onSaveToHistory={() =>
            navigate(`/patient-history/${assessmentResult.patient_id}`)
          }
        />
      )}
    </AppLayout>
