  ...
  const handleAddPatient = () => {
    if (
      ...
      toast({
        ...
        description: "Patient ID, first name, and last name are required.",
        variant: "destructive",
      });
      return;
    }
    ...
    toast({
      title: "Patient added",
      description: `${newPatient.first_name} ${newPatient.last_name} registered.`,
    });
  };
            ...
            <div className="space-y-4 mt-4">
              <div className="form-field">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewPatient((p) => ({ ...p, patient_id: e.target.value }))
                  }
                />
              </div>
        ...
        <EmptyState
          ...
          description={
            searchTerm
              ...
              : "Add a patient to begin risk assessments."
          }
          action={
            !searchTerm
              ? {
