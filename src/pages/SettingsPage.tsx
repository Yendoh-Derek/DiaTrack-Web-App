    ...
    <AppLayout>
      ...
      <div className="clinical-card mb-6 max-w-2xl">
        ...
        <div className="flex items-center justify-between">
          <div>
            <Label
              className="normal-case tracking-normal text-sm font-medium"
      ...
      <div className="clinical-card max-w-2xl">
        ...
        >
          <p>
            DiaTrack is a clinician-facing diabetes risk assessment demo.
            Predictions use an in-browser logistic regression model (ONNX). All
          ...
          <div>
            ...
            <p style={{ fontSize: "var(--text-body-sm)" }}>
              This application is for educational and portfolio demonstration
          ...
          >
            Version 1.0.0 · Model v{MODEL_VERSION} · ©{" "}
            {new Date().getFullYear()} DiaTrack
          </p>
        </div>
      </div>
    </AppLayout>
