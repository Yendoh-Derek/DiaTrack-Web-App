...
const RiskAssessmentResults: React.FC<RiskAssessmentResultsProps> = ({ result, onClose, onSaveToHistory }) => {
  return (
    <div
    ...
    >
      ...
      >
        <Card className="border-0 shadow-none">
          <CardHeader className="border-b" style={{ borderColor: 'var(--color-border-default)' }}>
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="clinical-card !p-4">
                ...
                <p className="font-semibold" style={{ fontSize: 'var(--text-body-md)' }}>
            ...
            {result.flagged_conditions.length > 0 && (
              ...
              >
                <h3
                  ...
                  style={{ color: 'var(--color-risk-high-text)', fontSize: 'var(--text-heading-sm)' }}
                >
                ...
                <ul className="space-y-1">
                  {result.flagged_conditions.map((condition, index) => (
                    <li key={index} style={{ fontSize: 'var(--text-body-sm)', color: 'var(--color-risk-high-text)' }}>
                      {condition}
                    </li>
                  ))}
                </ul>
            ...
            {result.feature_contributions.length > 0 && (
              <div className="clinical-card">
                <ModelInterpretability contributions={result.feature_contributions} />
              </div>
            )}

            <div className="clinical-card">
              <h3 className="clinical-card-title flex items-center gap-2 mb-3">
                <Info className="h-4 w-4" style={{ color: 'var(--color-brand-600)' }} aria-hidden="true" />
                Recommendations
              </h3>
